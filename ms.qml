...
<qgis version="2.12.2-Lyon" minimumScale="-4.65661e-10" maximumScale="100050" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="KATEGORI" forceraster="0" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="false" symbol="0" value="Berg i dagen" label="Berg i dagen"/>
      <category render="true" symbol="1" value="Sankmark, normal" label="Sankmark, normal"/>
      <category render="true" symbol="2" value="Sankmark, svårframkomlig" label="Sankmark, svårframkomlig"/>
      <category render="true" symbol="3" value="Sankmark, torvtäkt" label="Sankmark, torvtäkt"/>
    </categories>
    <symbols>
