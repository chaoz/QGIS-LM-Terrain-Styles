...
<qgis version="2.12.2-Lyon" minimumScale="0" maximumScale="50050" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="KATEGORI" forceraster="0" symbollevels="0" type="categorizedSymbol">
    <categories>
      ...
      <category render="true" symbol="5" value="Milstolpe" label="Milstolpe"/>
      <category render="true" symbol="6" value="Minnessten, upplysningssymbol" label="Minnessten, upplysningssymbol"/>
      <category render="true" symbol="7" value="Ruin" label="Ruin"/>
    </categories>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="marker" name="0">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="76,189,217,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="bebyggelslamning.svg"/>
          <prop k="offset" v="0,0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" name="3">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="114,127,210,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" name="4">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="223,21,51,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="gruvhal.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="0,0,0,255"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" name="6">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="46,213,135,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="minnessten.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="0,0,0,255"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" name="7">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="120,235,99,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="ruin.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="0,0,0,255"/>
